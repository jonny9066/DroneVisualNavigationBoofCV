...
public class CoordinateConverter {
    ...
    public static double[] xyzToLatLonDegrees(double[] xyz) {
        double degrees[] = CoordinateConverter.xyzToLatLonRadians(xyz);

        degrees[0] = degrees[0] * CoordinateConverter.RADIANS_TO_DEGREES;
        degrees[1] = degrees[1] * CoordinateConverter.RADIANS_TO_DEGREES;
    ...
    public static double[] getXYZfromLatLonDegrees(double latitude, double longitude, double height) {
        double degrees[] = CoordinateConverter.getXYZfromLatLonRadians(latitude * CoordinateConverter.DEGREES_TO_RADIANS,
                longitude * CoordinateConverter.DEGREES_TO_RADIANS,
                height);
